...
<tr><td>Course </td><td> <form:select path="student.stclass" onchange="loadvalues('years',this.value)" disabled="true">
<form:option value="">---Please Select---</form:option>
<form:options items="${studentbean.classes}" itemLabel="classDesc" itemValue="classValue"/>
</form:select>
</td>
<td>Studying Year</td> <td><form:select path="student.studyingyear" disabled="true" id="studyyear" onchange="loadvalues('sections',this.value);">
<form:option value="0" label="--Select--"></form:option>
<form:options items="${studentbean.studyingYears}" itemLabel="intvalue" itemValue="intvalue"/>
</form:select> </td>
<td>Section </td><td> <form:select path="student.section" disabled="true">
<form:option value="">---Please Select---</form:option>
<form:options items="${studentbean.sections}" itemLabel="sectionname" itemValue="sectionname"/>
</form:select>
</td>

<td>Medium </td><td> <form:select path="student.medium" disabled="true">
<form:option value="0">---Please Select---</form:option>
<form:options items="${studentbean.mediums}" itemLabel="mediumname" itemValue="mediumname"/>
</form:select>
</td>
<td>Roll NO </td><td> <form:input path="student.rollNo" disabled="true"/><form:errors path="student.rollNo" cssClass="error"/></td>
</tr>
...
<c:if test="${studentbean.student.collegeBlanceFee > 0}"><td><input type="button" value="Pay Fee" onclick="paybill('collegefee')"/></td> </c:if>
</tr>

<tr>
<td>Student Type</td> <td> <form:select path="student.studentType" disabled="true">
...
<tr><td>Hostel Name</td><td><form:input path="student.hostelName" disabled="true"/> </td><td>Admission Number</td><td><form:input path="student.hostelAdmissionNo"/> </td>  <td>Joined Date</td><td><form:input path="student.hostelJoinDate" id="hostelJoinDate"/></td> </tr>
...
<td>Balance Fee </td> <td> <form:input path="student.hostelBalanceFee" disabled="true"/> </td> 
<c:if test="${studentbean.student.hostelBalanceFee > 0}"><td><input type="button" value="Pay Bill" onclick="paybill('hostelfee')"/></td> </c:if> </tr>
<tr><td>Left Date </td><td><form:input path="student.hostelLeftDate" id="hostelLeftDate" disabled="true"/> </td> </tr>
...
<tr>
<td>Mobile</td><td> <form:input path="student.mobile" disabled="true"/><form:errors path="student.mobile" cssClass="error"/></td>
<td>Email</td><td> <form:input path="student.email" disabled="true"/></td>
<td>Occupation</td><td> <form:input path="student.occupation" disabled="true"/><form:errors path="student.occupation" cssClass="error"/></td>
</tr>
...
<tr>
<td>Present Address</td><td> <form:textarea path="student.presentAddress" disabled="true"/><form:errors path="student.presentAddress" cssClass="error"/></td>
<td>Permanent Address</td><td> <form:textarea path="student.premanentAddress" disabled="true"/><form:errors path="student.premanentAddress" cssClass="error"/><hr/></td>
</tr>
...
<tr>
<td>School Name</td><td><form:input path="student.prevschool" disabled="true"/><form:errors path="student.prevschool" cssClass="error"/> </td>
<td>Class</td><td> <form:select path="student.prevsStudClass" disabled="true">
<form:option value="0">---Please Select---</form:option>
<form:option value="-2">Nursery</form:option>
</form:select><form:errors path="student.prevsStudClass"/></td>
<td>Academic Year</td><td><form:select path="student.prevsStudyear" disabled="true">
<form:option value="0">---Please Select---</form:option>
...
<tr>
<td>Transfer Reason</td><td><form:input path="student.prevsReleaveReason" disabled="true"/><form:errors path="student.prevsReleaveReason" cssClass="error"/> </td>
<td>Conduct Issued</td><td><form:input path="student.prevconduct" disabled="true"/><form:errors path="student.prevconduct" cssClass="error"/> </td>
</tr>
<tr><td colspan="10"><hr/>
...
<form:checkbox path="student.issMarks" onclick="enable(this,'issmm')" disabled="true"/>Marks Sheet<input type="button" value="upload" id="issmm" onclick="upload('issmm')">
 <a href="#" onclick="downloadfile(${studentbean.student.mmid})">${studentbean.student.mmname}</a>
</c:otherwise>
</c:choose>
</td>
...
<tr>
<td>Re-leave Reason</td><td><form:input path="student.leaveReason" disabled="true"/></td>
<td>Re-leave Date</td><td><form:input path="student.collegeLeaveDate" disabled="true"/></td>
<td>Conduct</td><td><form:input path="student.issuedconduct" disabled="true"/></td>
</tr>
<tr>
<td></td><td></td>
<td>Status</td><td>
<form:select path="student.status" disabled="true">
<form:option value="Active">Active</form:option>
<form:option value="Left">Completed</form:option>
...
<td></td><td></td><td></td><td> <input type="button" value="Return" onclick="gotosearch()"/> </td>
</tr>
</table>
